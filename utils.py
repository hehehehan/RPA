...
CONFIG_ROOT = '../config' # <need to specify>
CONFIG_PATHS = {
...
# data info
UCF_IMAGE_ROOT = '../dataset/UCF101-Examples/' # <need to specify>


# save info
OPT_PATH = './result' # <need to specify>

# checkpoints path for ucf101
UCF_CKPT_PATH = '../TT_config_UCF' # <need to specify>

def change_cfg(cfg, batch_size, random):
    # modify video paths and pretrain setting.
    cfg.CONFIG.DATA.VAL_DATA_PATH = '../dataset/Kinetics-Examples/' # <need to specify>
